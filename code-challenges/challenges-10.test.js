...
const createServer = () => {
  ...
  const app = express();
  app.get('/hello', (req, res) => { res.send('hello y\'all!'); });
  app.get('/aboutme', (req, res) => { res.send('I do not know what to say lol'); });
  app.get('/favoritefoods', (req, res) => { res.send('[eded,dwdwd,edef]'); });
